...
export default function CountdownCard({ title, date, icon }: CountdownCardProps) {
  ...
  return (
    <motion.div
      ...
      className="bg-white/80 dark:bg-slate-700/80 backdrop-blur-xl rounded-2xl p-4 border border-white/50 dark:border-slate-700/50 shadow-md flex items-center gap-4 cursor-pointer"
    >
      ...
      <div className="flex-1 min-w-0">
        ...
        <p className="text-xs text-slate-500 dark:text-slate-300 mt-0.5">{date}</p>
      </div>
      <div className="bg-sky-50 dark:bg-sky-900/40 rounded-xl px-3 py-2 text-center flex-shrink-0">
